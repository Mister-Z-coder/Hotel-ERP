...
namespace Hotel.Migrations
{
    ...
    [Migration("20250416140714_Bougerbinga")]
    partial class Bougerbinga
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$b4IvD6n6jDfScYUrdWiL1eeVWxP51.6O/1eMbqBpgSt1nfbzS4hxi",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$Og6EldPnA6p.AbzLipQH2.ZPbjMtDF6z4Pwi5sNxVo4ic0Vy90B/a",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
            ...
            modelBuilder.Entity("Hotel.Models.Livraison", b =>
                {
                    ...
                    b.Property<int?>("ApprovisionnementDemandeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApprovisionnementDemandeId");
            ...
            modelBuilder.Entity("Hotel.Models.Livraison", b =>
                {
                    b.HasOne("Hotel.Models.Approvisionnement", "Approvisionnement")
                        .WithMany()
                        .HasForeignKey("ApprovisionnementDemandeId");
