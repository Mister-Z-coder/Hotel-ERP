...
namespace Hotel.Migrations
{
    ...
    [Migration("20250331142007_Bingahouse")]
    partial class Bingahouse
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$ymt1HjInRK183f8BGGhWoOpEvUsBdaedcM.xzE0si/gjJpbyzRldu",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$QgVJ460uUfYDkTa/LsgsoOf0GvBnv8EO8iAUWK7yep3OHJz8UBX72",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
