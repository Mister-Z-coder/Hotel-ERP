...
namespace Hotel.Migrations
{
    ...
    [Migration("20250410102342_Bingahousessss")]
    partial class Bingahousessss
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$liXeExK5c5a3s.eNko89FulhANys.RLPAmAKq92AyzSIJdaRrM1xu",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$X6418YUnJNVRxa8w8MoOU.4..EcEHaGtRdCGcyy8rqco4HLDda8s.",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
