...
namespace Hotel.Migrations
{
    ...
    [Migration("20250331164259_Bingav")]
    partial class Bingav
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$cDUTRmC1IO9exuiRPIpW5.kEmMZDrBItF.1/xYI1lSFqetjkJBnii",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$52sKtjkHt1OsZ8J4q.ULPew1b7DuSnvdMOTc5cNTqwjlnCYOWzr.O",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
