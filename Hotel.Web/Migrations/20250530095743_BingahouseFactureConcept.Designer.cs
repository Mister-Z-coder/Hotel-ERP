...
namespace Hotel.Migrations
{
    ...
    [Migration("20250530095743_BingahouseFactureConcept")]
    partial class BingahouseFactureConcept
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel.Models.Aliment", b =>
                {
                    ...
                    b.Property<string>("UniteAliment")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Hotel.Models.Boisson", b =>
                {
                    ...
                    b.Property<string>("UniteBoisson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Hotel.Models.Bouger", b =>
                {
                    ...
                    b.Property<int>("QteBouger")
                        .HasColumnType("int");

                    b.HasKey("MouvementId", "BoissonId");
            ...
            modelBuilder.Entity("Hotel.Models.Comporter", b =>
                {
                    ...
                    b.Property<int>("QteOrdone")
                        .HasColumnType("int");

                    b.HasKey("DemandeId", "AlimentId");

                    b.HasIndex("AlimentId");

                    b.ToTable("Comporters");
                });

            modelBuilder.Entity("Hotel.Models.Comprendre", b =>
                {
                    b.Property<int>("DemandeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("DemandeId", "BoissonId");

                    b.HasIndex("BoissonId");

                    b.ToTable("Comprendres");
                });
            ...
            modelBuilder.Entity("Hotel.Models.Demande", b =>
                {
                    b.Property<int>("DemandeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel.Models.DetailsCommandeHistorique", b =>
                {
                    b.Property<int>("DetailsCommandeHistoriqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("DetailsCommandeHistoriqueId");

                    b.ToTable("DetailsCommandeHistoriques");
                });

            modelBuilder.Entity("Hotel.Models.DetailsDeclassement", b =>
                {
                    b.Property<int>("DetailsDeclassementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("DeclassementId")
                        .HasColumnType("int");

                    b.Property<DateTime>("HeureMouvement")
                        .HasColumnType("datetime2");

                    b.Property<string>("MotifDeclassement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NatureMouvement")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProduitDeclasse")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("QteDeclasse")
                        .HasColumnType("int");

                    b.Property<string>("TypeMouvement")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("DetailsDeclassementId");

                    b.ToTable("DetailsDeclassements");
                });

            modelBuilder.Entity("Hotel.Models.DetailsDemande", b =>
                {
                    b.Property<int>("DetailsDemandeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("EtatDemande")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ProduitDemande")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Hotel.Models.DetailsLivraison", b =>
                {
                    b.Property<int>("DetailsLivraisonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime>("HeureLivraison")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("ProduitLivre")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("QteLivre")
                        .HasColumnType("int");

                    b.Property<string>("TypeMouvement")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("DetailsLivraisonId");

                    b.ToTable("DetailsLivraisons");
                });

            modelBuilder.Entity("Hotel.Models.DetailsMouvement", b =>
                {
                    b.Property<int>("DetailsMouvementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("ProduitMouvement")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("DetailsMouvementId");

                    b.ToTable("DetailsMouvements");
                });
            ...
            modelBuilder.Entity("Hotel.Models.DetailsSortie", b =>
                {
                    b.Property<int>("DetailsSortieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("DetailsSortieId");

                    b.ToTable("DetailsSorties");
                });
            ...
            modelBuilder.Entity("Hotel.Models.HistoriqueReglement", b =>
                {
                    b.Property<string>("Agent")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("HistoriqueReglements");
                });
            ...
            modelBuilder.Entity("Hotel.Models.MaintenanceChambre", b =>
                {
                    b.Property<int>("MaintenanceChambreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<DateTime?>("HeureDebutMaintenance")
                        .IsRequired()
                        .HasColumnType("datetime2");

                    b.Property<string>("ObservationDebutMaintenance")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MaintenanceChambreId");

                    b.HasIndex("AgentId");

                    b.HasIndex("ChambreId");

                    b.ToTable("MaintenanceChambres");
                });
            ...
            modelBuilder.Entity("Hotel.Models.Mouvement", b =>
                {
                    b.Property<int>("MouvementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Hotel.Models.Mouvoir", b =>
                {
                    b.Property<int>("MouvementId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MouvementId", "AlimentId");
            ...
            modelBuilder.Entity("Hotel.Models.ReglementCommande", b =>
                {
                    ...
                    b.HasKey("ReglementId", "CommandeId");
            ...
            modelBuilder.Entity("Hotel.Models.ReglementCommandeHistorique", b =>
                {
                    b.Property<int>("ReglementId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReglementCommandeHistoriques");
                });

            modelBuilder.Entity("Hotel.Models.ReglementHistorique", b =>
                {
                    b.Property<int>("ReglementHistoriqueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ReglementHistoriqueId");

                    b.ToTable("ReglementHistoriques");
                });
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$rulvuymGrbwpUMgxifziN.q8bYuE7/wiY5CHyMtmWpnMIhj2K2H1O",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$7rRkCaCRqTqCro/Xx.NuGO1IH5sqr14B66NvPldDMREGnHsA2/x56",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
            ...
            modelBuilder.Entity("Hotel.Models.Ajout", b =>
                {
                    b.HasBaseType("Hotel.Models.Demande");

                    b.Property<string>("EtatDemandeAjout")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("Ajouts");
                });

            modelBuilder.Entity("Hotel.Models.Approvisionnement", b =>
                {
                    b.HasBaseType("Hotel.Models.Demande");

                    b.Property<string>("EtatDemandeAppro")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("Approvisionnements");
                });

            modelBuilder.Entity("Hotel.Models.FinMaintenanceChambre", b =>
                {
                    b.HasBaseType("Hotel.Models.MaintenanceChambre");

                    b.Property<DateTime?>("DateFinMaintenance")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("HeureFinMaintenance")
                        .HasColumnType("datetime2");

                    b.Property<string>("ObservationFinMaintenance")
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("FinMaintenanceChambres");
                });

            modelBuilder.Entity("Hotel.Models.Declassement", b =>
                {
                    b.HasBaseType("Hotel.Models.Mouvement");

                    b.Property<string>("MotifDecaissement")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.ToTable("Declassements");
                });

            modelBuilder.Entity("Hotel.Models.Livraison", b =>
                {
                    b.HasBaseType("Hotel.Models.Mouvement");
            ...
            modelBuilder.Entity("Hotel.Models.SortiePourAjout", b =>
                {
                    b.HasBaseType("Hotel.Models.Mouvement");
            ...
            modelBuilder.Entity("Hotel.Models.Bouger", b =>
                {
                    ...
                    b.HasOne("Hotel.Models.Mouvement", "Mouvement")
                        .WithMany("Bougers")
            ...
            modelBuilder.Entity("Hotel.Models.Comporter", b =>
                {
                    ...
                    b.HasOne("Hotel.Models.Demande", "Demande")
                        .WithMany("Comporters")
            ...
            modelBuilder.Entity("Hotel.Models.Mouvement", b =>
                {
                    ...
                    b.HasOne("Hotel.Models.TypeMouvement", "TypeMouvement")
                        .WithMany()
            ...
            modelBuilder.Entity("Hotel.Models.ReglementCommande", b =>
                {
                    ...
                    b.HasOne("Hotel.Models.Reglement", "Reglement")
                        .WithMany("Commandes")
            ...
            modelBuilder.Entity("Hotel.Models.Ajout", b =>
                {
                    b.HasOne("Hotel.Models.Demande", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.Ajout", "DemandeId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Hotel.Models.Approvisionnement", b =>
                {
                    b.HasOne("Hotel.Models.Demande", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.Approvisionnement", "DemandeId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Hotel.Models.FinMaintenanceChambre", b =>
                {
                    b.HasOne("Hotel.Models.MaintenanceChambre", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.FinMaintenanceChambre", "MaintenanceChambreId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Hotel.Models.Declassement", b =>
                {
                    b.HasOne("Hotel.Models.Mouvement", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.Declassement", "MouvementId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Hotel.Models.Livraison", b =>
                {
                    b.HasOne("Hotel.Models.Approvisionnement", "Approvisionnement")
                        .WithMany()
                    ...
                    b.HasOne("Hotel.Models.Mouvement", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.Livraison", "MouvementId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hotel.Models.SortiePourAjout", b =>
                {
                    b.HasOne("Hotel.Models.Ajout", "Ajout")
                        .WithMany()
                        .HasForeignKey("AjoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hotel.Models.Mouvement", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.SortiePourAjout", "MouvementId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hotel.Models.Aliment", b =>
                {
                    b.Navigation("Comporters");

                    b.Navigation("Fournirs");

                    b.Navigation("Mouvoirs");
            ...
            modelBuilder.Entity("Hotel.Models.Boisson", b =>
                {
                    b.Navigation("Bougers");

                    b.Navigation("Comprendres");
