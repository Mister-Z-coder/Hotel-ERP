...
namespace Hotel.Migrations
{
    ...
    [Migration("20250415235636_Bingahousefinalapp")]
    partial class Bingahousefinalapp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$AgTCN7Z2MyJkNOpiAglk6uv4djoB4x5MfBBHo26py8dF38GpmDMaq",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$4xQCRBAPLMHUB3ZxxMcuyeFuFLe8rm5aDolaUksBLUqt1Hqpe.OTW",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
            ...
            modelBuilder.Entity("Hotel.Models.Decaissement", b =>
                {
            ...
            modelBuilder.Entity("Hotel.Models.Decaissement", b =>
                {
                    b.HasOne("Hotel.Models.Mouvement", null)
                        .WithOne()
                        .HasForeignKey("Hotel.Models.Decaissement", "MouvementId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
