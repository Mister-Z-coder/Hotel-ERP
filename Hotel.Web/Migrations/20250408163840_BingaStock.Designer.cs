...
namespace Hotel.Migrations
{
    ...
    [Migration("20250408163840_BingaStock")]
    partial class BingaStock
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$Key/W6BLKUITllz5.B8dxOJ9K2ukuapMDgy0Mxhl/BmkLEuEXIlGi",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$z1s8as2hA0GH2nBmA6SYXeoTwdN9jfgRan5vXuerQI6ec4fPGauGi",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
