...
namespace Hotel.Migrations
{
    ...
    [Migration("20250402214643_Bingahousey")]
    partial class Bingahousey
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$Tr7crGJTjDRuQW6W4LdAseQQHbpzsh3h/ECDKw2VVfx3O1/Ec/bpG",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$bokigNk9ZX4M3/GHvxYlL.vPi0D5wLO6hb2qbbSuHdoZiUE0PyZka",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
