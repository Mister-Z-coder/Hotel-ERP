...
namespace Hotel.Migrations
{
    ...
    [Migration("20250403124502_Bingahousefinal")]
    partial class Bingahousefinal
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$.iIkYSLVz8.3Q7YkW8H18ORWIG/FqKsqYcMMqgI/Xjd3OhzuDDXXe",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$vfos53d.tfwYHIZQte3h1.DQW1WM73Z5xh4zWMERDTYjvvJubTW.O",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
