...
namespace Hotel.Migrations
{
    ...
    [Migration("20250410033123_Bingahousez")]
    partial class Bingahousez
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$aiD4IOBec./PoFJjRci53eKUXgUDQFTHnVaLdnHEH.fkS9TvO/ldS",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$g5bbdJZ8Igo2lQWfj6.58eTO2FeWMHMCO7iMtqCMGbG8dW.fjDmc2",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
