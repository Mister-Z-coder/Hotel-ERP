...
namespace Hotel.Migrations
{
    ...
    [Migration("20250409131018_BIngahouse25")]
    partial class BIngahouse25
    {
            ...
            modelBuilder.Entity("Hotel.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AgentId = 1,
                            Password = "$2a$12$cnL9Pe6I3T.MmxPLSFZCxeYnddIdzRmx6HNClxy2LarnwLTWr5J/K",
                            Role = "ADMIN",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            AgentId = 2,
                            Password = "$2a$12$au5IMjHzO2f6qZSqkVQ87O0P.2liZaGPKkGobnH6cC66BiL/9XORW",
                            Role = "CAISSIER",
                            Username = "user"
                        });
                });
